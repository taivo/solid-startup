...
export declare class Overrides extends APIResource {
     ...
     * [previous version of WAF managed rules](https://developers.cloudflare.com/support/firewall/managed-rules-web-application-firewall-waf/understanding-waf-managed-rules-web-application-firewall/).
     */
    update(overridesId: string, params: OverrideUpdateParams, options?: Core.RequestOptions): Core.APIPromise<Override>;
    /**
     ...
     * [previous version of WAF managed rules](https://developers.cloudflare.com/support/firewall/managed-rules-web-application-firewall-waf/understanding-waf-managed-rules-web-application-firewall/).
     */
    list(params: OverrideListParams, options?: Core.RequestOptions): Core.PagePromise<OverridesV4PagePaginationArray, Override>;
    /**
     ...
     * [previous version of WAF managed rules](https://developers.cloudflare.com/support/firewall/managed-rules-web-application-firewall-waf/understanding-waf-managed-rules-web-application-firewall/).
     */
    delete(overridesId: string, params: OverrideDeleteParams, options?: Core.RequestOptions): Core.APIPromise<OverrideDeleteResponse>;
    /**
     ...
     * [previous version of WAF managed rules](https://developers.cloudflare.com/support/firewall/managed-rules-web-application-firewall-waf/understanding-waf-managed-rules-web-application-firewall/).
     */
    get(overridesId: string, params: OverrideGetParams, options?: Core.RequestOptions): Core.APIPromise<Override>;
}
