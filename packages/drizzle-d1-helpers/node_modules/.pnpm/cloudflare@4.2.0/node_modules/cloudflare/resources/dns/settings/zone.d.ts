...
export declare class Zone extends APIResource {
    /**
...
export declare namespace ZoneEditResponse {
    /**
     * Settings for this internal zone.
     */
...
export declare namespace ZoneGetResponse {
    /**
     * Settings for this internal zone.
     */
    interface InternalDNS {
...
export declare namespace Zone {
    export { type ZoneEditResponse as ZoneEditResponse, type ZoneGetResponse as ZoneGetResponse, type ZoneEditParams as ZoneEditParams, type ZoneGetParams as ZoneGetParams, };
}
