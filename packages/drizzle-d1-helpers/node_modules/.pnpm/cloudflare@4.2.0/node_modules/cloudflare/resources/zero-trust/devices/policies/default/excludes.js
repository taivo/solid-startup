...
class Excludes extends resource_1.APIResource {
    ...
    update(params, options) {
        ...
        return this._client.getAPIList(`/accounts/${account_id}/devices/policy/exclude`, policies_1.SplitTunnelExcludesSinglePage, { body: body, method: 'put', ...options });
    }
    /**
    ...
    get(params, options) {
        ...
        return this._client.getAPIList(`/accounts/${account_id}/devices/policy/exclude`, policies_1.SplitTunnelExcludesSinglePage, options);
    }
}
