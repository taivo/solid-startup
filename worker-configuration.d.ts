/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e1bb734d0e04907606d922e25b9432cc)
// Runtime types generated with workerd@1.20250507.0 2025-04-29 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		__DEMO_MODE_DO_NOT_USE__: string;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "__DEMO_MODE_DO_NOT_USE__">> {}
}
